...
// Variabel untuk mengelola pagination dan pencarian
...
document.addEventListener('DOMContentLoaded', function() {
    // Mendapatkan semua tab dan baris tabel
    ...
    tabs.forEach(tab => {
        tab.addEventListener('click', function(event) {
            ...
            console.log(`Status yang dipilih: ${status}`); // Debugging: menampilkan status yang dipilih
