                        ...
                        <div class="app-utilities col-auto">
                            <div class="app-utility-item app-notifications-dropdown dropdown">
                                <a class="dropdown-toggle no-toggle-arrow" id="notifications-dropdown-toggle"
                                    ...
                                    <span class="badge text-bg-danger text-white position-relative" style="top: -10px; right: 5px;">{{ $totalMessage }}</span> 
                                    {{-- banyak pesan --}}
                ...
                <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        ...
                        <li class="nav-item has-submenu">
                            ...
                            <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                                <ul class="submenu-list list-unstyled">
                                    ...
                                    <li class="submenu-item {{ $title == 'Settings' ? 'active' : '' }}"><a
                                            class="submenu-link" href="{{ route('settings') }}">Settings</a>
                                    </li>
                                </ul>
                            </div>
                        </li><!--//nav-item-->
                        <ul class="app-menu footer-menu list-unstyled">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ $title == 'Cabang' ? 'active' : '' }}"
                                    href="{{ route('cabang') }}">
                                    <span class="nav-icon">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ $title == 'Pegawai' ? 'active' : '' }}"
                                    href="{{ route('pegawai') }}">
                                    <span class="nav-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
