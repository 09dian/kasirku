...
Route::post('/', [LoginController::class, 'ActionLogin'])
    ->middleware('guest')
    ->name('login');
...
Route::get('/settings', [SettingsController::class, 'settings'])
    ->middleware('auth')
    ->name('settings');
Route::put('/settings_update', [SettingsController::class, 'update'])
    ->middleware('auth')
    ->name('settings_update');
Route::put('/settings', [SettingsController::class, 'update_pembayaran'])
    ->middleware('auth')
    ->name('settings');

//pesan
Route::get('/notifikasi/{receiver_id}', [MessageController::class, 'index'])
    ->middleware('auth')
    ->name('notifikasi'); //untuk balas pesan dan kirim
Route::post('/messages/{pegawaiId}', [MessageController::class, 'storeMessage'])
    ->middleware('auth')
    ->name('messages'); // untuk kirim pesan dan balas pesan
...
Route::patch('/produk/{id}', [ProdukController::class, 'update'])
    ->middleware('auth')
    ->name('produk_update');
Route::get('/tambah_produk', [ProdukController::class, 'produk'])
    ->middleware('auth')
    ->name('tambah_produk');
...
Route::get('/kategori', [KategoriController::class, 'index'])
    ->middleware('auth')
    ->name('kategori');
Route::post('/tambah_kategori', [KategoriController::class, 'create'])
    ->middleware('auth')
...
Route::get('/tambah_kategori', [KategoriController::class, 'kategori'])
    ->middleware('auth')
    ->name('tambah_kategori'); //kategorit

// Route Khusus untuk pegawai Controller untuk pegawai diawali dengan P -> exp : (PMessagesController)
Route::post('/login_pegawai', [LoginPegawaiController::class, 'ActionLogin'])
    ->middleware('guest')
    ->name('login_pegawai');
...
Route::get('/logout_pegawai', [LoginPegawaiController::class, 'logout'])
    ->middleware('auth:pegawai')
    ->name('logout_pegawai'); // Pastikan hanya pegawai yang login yang bisa mengakses
Route::get('/pegawai_notifikasi/{receiver_id}', [PMessagesController::class, 'index'])
    ->middleware('auth:pegawai')
    ->name('pegawai_notifikasi');
Route::post('/pegawai_notifikasi/{id}', [PMessagesController::class, 'store'])
    ->middleware('auth:pegawai')
    ->name('message');
